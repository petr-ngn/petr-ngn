...
- [**NLP Chatbot for Faculty of Informatics and Statistics (FIS) VŠE** (_will be published once the project will be defended)_](https://github.com/petr-ngn/FIS_Chatbot)
